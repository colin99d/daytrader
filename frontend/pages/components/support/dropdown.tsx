                    ...
                    <div className="px-1 py-1 ">
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          ...
                          >
                            {active ? (
                              <this.DuplicateActiveIcon
                                className="w-5 h-5 mr-2"
                                aria-hidden="true"
                              />
                            ) : (
                              <this.DuplicateInactiveIcon
                                className="w-5 h-5 mr-2"
                                aria-hidden="true"
                              />
                            )}
                    ...
                    <div className="px-1 py-1">
                      <Menu.Item>
                        {({ active }) => (
                          ...
                          >
                            {active ? (
                              <this.ArchiveActiveIcon
                                className="w-5 h-5 mr-2"
                                aria-hidden="true"
                              />
                            ) : (
                              <this.ArchiveInactiveIcon
                                className="w-5 h-5 mr-2"
                                aria-hidden="true"
                              />
                            )}
